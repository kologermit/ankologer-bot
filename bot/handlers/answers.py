...
Меня зовут <b>Кологерманская Анна Николаевна</b>, я учитель информатики и профориентолог🖥 
Познакомимся ближе?🔍"""
    yes = "Да✅"
    no = "Нет❌"
    correct = "Верно✅"
...
<b>Номер телефона:</b> {phone}"""
    ...
    class Admin:
        ...
        mailing = "Отправьте сообщение, голосовое сообщение, видео сообщение, чтобы отправить всем пользователям бота"